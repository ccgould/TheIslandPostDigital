...
using IPDLibrary.Interfaces;
using IPDLibrary.Models;



namespace IPDLibrary.Services;
...
;
    ...
    public async Task<double> GetTodaysTotal(DateTime date, ViewModels.EarningsPageViewmodel.TransactionType transactionType)
    {
        ...
        try
        {
            ...
            command.Parameters.AddWithValue("@cashType", transactionType == ViewModels.EarningsPageViewmodel.TransactionType.Cash ? "Cash" : "Card");
